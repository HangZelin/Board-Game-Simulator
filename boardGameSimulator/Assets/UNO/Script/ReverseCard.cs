...
namespace UNO
{
    public class ReverseCard : MonoBehaviour, Card
    {
        ...
        public GameObject Copy(Transform transform)
        {
            ...
            copy.GetComponent<ReverseCard>().Initialize(color);
            copy.name = ToString();
            return copy;
        }
        ...
        public override string ToString()
        {
            switch (color)
            {
                case Color.Blue: return "Reverse_blue";
                case Color.Green: return "Reverse_green";
                case Color.Red: return "Reverse_red";
                case Color.Yellow: return "Reverse_yellow";
            }
            Debug.Log("Failed ReverseCard ToString Method");
            return "";
        }
    }
}
